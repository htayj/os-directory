...
title: Pilot
description: Draft inventory record for Pilot.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Pilot", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Pilot", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Pilot_(operating_system), title: "Pilot", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Pilot_(operating_system)
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q750428
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Pilot_(operating_system)).
