...
title: OS/8
description: Draft inventory record for OS/8.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "OS/8", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "OS/8", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/OS/8, title: "OS/8", source_kind: article }]
---
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/OS/8).
