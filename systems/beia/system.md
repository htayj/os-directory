...
title: BeIA
description: Be Inc.'s named BeOS-derived information-appliance operating system.
tags: [operating-system, be-inc, beos, embedded]
status: draft
schema_version: "0.1"
as_of: 2026-07-26
...
source_list: { title: List of operating systems, revision: 1365063001, occurrences: [{ section: [Proprietary, Be Inc.], label: BeIA, position: 62, target: https://en.wikipedia.org/wiki/BeIA, depth: 2, parent_position: 61 }] }
discovery_provenance: [{ method: english-list, language: en, native_label: BeIA, source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: BeIA, kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: [{ organization: Be Inc., roles: [developer, vendor], evidence: [wikipedia], assertion_status: provisional }]
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/BeIA, title: BeIA, source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/BeIA
...
BeIA is retained as a separately named Be Inc. system identity rather than
collapsed into BeOS.[^wikipedia]

[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/BeIA).
