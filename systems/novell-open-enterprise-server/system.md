...
description: Draft inventory record for Novell Open Enterprise Server.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Novell Open Enterprise Server", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Novell Open Enterprise Server", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Novell_Open_Enterprise_Server).
