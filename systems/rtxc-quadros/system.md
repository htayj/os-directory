...
title: RTXC Quadros
description: Draft inventory record for RTXC Quadros.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "RTXC Quadros", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "RTXC Quadros", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/RTXC_Quadros, title: "RTXC Quadros", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/RTXC_Quadros
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/RTXC_Quadros).
