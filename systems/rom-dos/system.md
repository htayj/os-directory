...
title: ROM-DOS
description: Draft inventory record for ROM-DOS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "ROM-DOS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "ROM-DOS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/ROM-DOS, title: "ROM-DOS", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/ROM-DOS
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/ROM-DOS).
