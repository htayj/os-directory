...
description: Draft inventory record for THE multiprogramming system.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "THE multiprogramming system", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "THE multiprogramming system", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/THE_multiprogramming_system).
