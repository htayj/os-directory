...
title: Replicant
description: Draft inventory record for Replicant.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Replicant", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Replicant", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Replicant_(operating_system), title: "Replicant", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Replicant_(operating_system)
  ...
  fields:
    ...
    first_release: Mid-2010 ; 16 years ago ( 2010 )
    latest_release: 6.0 0004 (June 3, 2022 ; 4 years ago ( 2022-06-03 ) ) [ ± ]
    last_updated: 6.0 0004 (June 3, 2022 ; 4 years ago ( 2022-06-03 ) ) [ ± ]
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Replicant_(operating_system)).
