...
title: Transaction Management eXecutive
description: Draft inventory record for Transaction Management eXecutive.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Transaction Management eXecutive", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Transaction Management eXecutive", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Transaction_Management_eXecutive, title: "Transaction Management eXecutive", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Transaction_Management_eXecutive
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q524989
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Transaction_Management_eXecutive).
