...
names: [{ value: "MIPS RISC/os", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/MIPS_RISC/os
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q1631366
