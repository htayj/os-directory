...
discovery_provenance:
  - { method: multilingual-manifest, language: "es", native_label: "Trisquel GNU/Linux", source: inventory/multilingual/manifests/batch-004.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Trisquel GNU/Linux", kind: official, language: "es", script: Latn, evidence: [discovery], assertion_status: provisional }
organizations: []
countries_of_origin: []
design_purposes: []
...
Discovery rationale: Spanish free GNU/Linux distribution originally sponsored by the Universidad de Vigo. It is a distribution with Linux-libre, not the kernel itself.
