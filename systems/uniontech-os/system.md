...
title: "统信操作系统"
description: Draft multilingual inventory record for 统信操作系统.
...
discovery_provenance:
  - { method: multilingual-manifest, language: zh, native_label: "统信操作系统", source: inventory/multilingual/manifests/batch-012.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "统信操作系统", kind: official, language: zh, script: Hani, evidence: [multilingual-manifest], assertion_status: provisional }
...
Chinese Linux-based desktop/server operating-system identity.
