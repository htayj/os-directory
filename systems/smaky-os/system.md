...
title: "Smaky"
description: Draft multilingual inventory record for Smaky.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "Smaky", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Smaky", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
French-language operating-system identity from the French listing; origin normalization and technical attributes remain unresearched.
