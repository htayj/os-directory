...
description: Draft inventory record for Time Sharing Operating System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Time Sharing Operating System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Time Sharing Operating System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Time_Sharing_Operating_System, title: "Time Sharing Operating System", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Time_Sharing_Operating_System
  ...
  fields:
    ...
    first_release: 1968 ; 58 years ago ( 1968 )
    latest_release: null
    last_updated: null
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q218038
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Time_Sharing_Operating_System).
