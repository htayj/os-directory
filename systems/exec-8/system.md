...
title: EXEC 8
description: Draft inventory record for EXEC 8.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "EXEC 8", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "EXEC 8", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/EXEC_8).
