...
description: Draft inventory record for PlayStation Vita system software.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "PlayStation Vita system software", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "PlayStation Vita system software", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/PlayStation_Vita_system_software).
