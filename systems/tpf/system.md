...
title: Transaction Processing Facility
description: Draft inventory record for Transaction Processing Facility.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Transaction Processing Facility", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Transaction Processing Facility", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Transaction_Processing_Facility).
