...
description: Draft multilingual inventory record for Lihuen GNU/Linux.
...
discovery_provenance:
  - { method: multilingual-manifest, language: es, native_label: "Lihuen GNU/Linux", source: inventory/multilingual/manifests/batch-003.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Lihuen GNU/Linux", kind: official, language: es, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
...
Argentine university-developed GNU/Linux distribution; country evidence is direct from the multilingual manifest.
