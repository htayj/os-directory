...
title: "أوروك جنو/لينكس (Uruk GNU/Linux-libre)"
description: Draft multilingual inventory record for أوروك جنو/لينكس (Uruk GNU/Linux-libre).
...
discovery_provenance:
  - { method: multilingual-manifest, language: ar, native_label: "أوروك جنو/لينكس (Uruk GNU/Linux-libre)", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "أوروك جنو/لينكس (Uruk GNU/Linux-libre)", kind: official, language: ar, script: Arab, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: [IQ]
first_pass_attributes:
  developer: null
  country_of_origin: IQ
  purpose: null
...
Iraqi-origin free Linux distribution; first-pass country evidence is direct from the discovery source.
