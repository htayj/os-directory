...
title: "DOS EC"
description: Draft multilingual inventory record for DOS EC.
...
discovery_provenance:
  - { method: multilingual-manifest, language: cs, native_label: "DOS EC", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "DOS EC", kind: official, language: cs, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
Czechoslovak disk operating-system family; named variants require later release research.
