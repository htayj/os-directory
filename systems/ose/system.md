...
title: Operating System Embedded
...
names: [{ value: "Operating System Embedded", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Operating_System_Embedded
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q1341066
