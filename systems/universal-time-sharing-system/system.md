...
title: Universal Time-Sharing System
description: Draft inventory record for Universal Time-Sharing System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Universal Time-Sharing System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Universal Time-Sharing System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Universal_Time-Sharing_System, title: "Universal Time-Sharing System", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Universal_Time-Sharing_System
  ...
  fields:
    ...
    purpose: null
    programming_languages: Assembly Language (Meta-Symbol)
    first_release: 1966 ; 60 years ago ( 1966 )
    latest_release: D00 / Q1, 1973
    last_updated: D00 / Q1, 1973
    development_status: Discontinued
    source_model: Unknown
    os_family: Not Applicable
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Universal_Time-Sharing_System).
