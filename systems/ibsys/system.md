...
names: [{ value: "IBM 7090/94 IBSYS", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/IBM_7090/94_IBSYS
  ...
  fields:
    ...
    first_release: 1960 ; 66 years ago ( 1960 )
    latest_release: null
    last_updated: null
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q620465
