...
names: [{ value: "EulerOS", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/EulerOS
  ...
  fields:
    ...
    purpose: Servers , Cloud computing , Personal computers , [ citation needed ]
      Embedded devices , [ citation needed ] Edge computing , Industrial
    programming_languages: null
    first_release: December 31, 2019 ; 6 years ago ( 2019-12-31 ) (EulerOS)
    latest_release: 25.09 (September 2025)
    last_updated: 25.09 (September 2025)
    development_status: Active
    source_model: Open-source
    os_family: Linux ( Unix-like ), Unix (Compliant), HarmonyOS , OpenHarmony (openEuler
      Embedded (multi-kernel))
    gui: null
    platforms: AArch64 (TaiShan), LinxiISA (LinxCore) ( Kunpeng ), x86-64 , 32-bit
      ARM , IA-32 , RISC-V , and LoongArch
    kernel_type: Monolithic ( Linux ), multi-kernel (openEuler) with UniProton Microkernel
      RTOS
