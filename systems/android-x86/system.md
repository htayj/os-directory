...
title: Android-x86
description: Draft inventory record for Android-x86.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Android-x86", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Android-x86", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Android-x86).
