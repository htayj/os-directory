...
title: PC-MOS/386
description: Draft inventory record for PC-MOS/386.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "PC-MOS/386", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "PC-MOS/386", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/PC-MOS/386, title: "PC-MOS/386", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/PC-MOS/386
  ...
  fields:
    ...
    purpose: null
    programming_languages: 80x86 assembly language , C
    first_release: 1987 ; 39 years ago ( 1987 )
    latest_release: '5.01'
    last_updated: '5.01'
    development_status: Active
    source_model: Open source , originally closed source
    os_family: DOS
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q2581974
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/PC-MOS/386).
