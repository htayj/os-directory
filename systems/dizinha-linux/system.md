...
title: "Dizinha Linux"
description: Draft multilingual inventory record for Dizinha Linux.
...
discovery_provenance:
  - { method: multilingual-manifest, language: pt, native_label: "Dizinha Linux", source: inventory/multilingual/manifests/batch-010.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Dizinha Linux", kind: official, language: pt, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
