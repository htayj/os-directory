...
names: [{ value: "GM-NAA I/O", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/GM-NAA_I/O
  ...
  fields:
    ...
    first_release: 1956 ; 70 years ago ( 1956 )
    latest_release: null
    last_updated: null
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q519560
