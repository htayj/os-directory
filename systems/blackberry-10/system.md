...
names: [{ value: "BlackBerry 10", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/BlackBerry_10
  ...
  fields:
    ...
    purpose: null
    programming_languages: C , C++ , Qt
    first_release: January 30, 2013 ; 13 years ago ( 2013-01-30 )
    latest_release: null
    last_updated: null
    development_status: null
    source_model: Closed source
    os_family: Unix-like , QNX
    gui: Graphical
    platforms: ARM
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q879989
