...
title: OS/VS1
description: IBM virtual-storage operating-system identity.
...
source_list: { title: "List of operating systems", revision: 1365063001, occurrences: [{ section: [Proprietary, IBM], label: "OS/VS1", position: 0, target: "https://en.wikipedia.org/wiki/OS/VS1", depth: 1 }] }
