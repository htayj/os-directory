...
names: [{ value: "CSI-DOS", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/CSI-DOS
  ...
  fields:
    ...
    first_release: null
    latest_release: not less 3.32
    last_updated: not less 3.32
    development_status: Abandoned
    source_model: null
    os_family: null
    gui: X-Shell graphical file manager
