...
title: Spring
description: Draft inventory record for Spring.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Spring", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Spring", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Spring_(operating_system), title: "Spring", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Spring_(operating_system)
  ...
  fields:
    ...
    os_family: Unix-like
    gui: null
    platforms: SPARCstation 2 , SPARCstation 4 , SPARCstation 5 , SPARCstation Voyager
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Spring_(operating_system)).
