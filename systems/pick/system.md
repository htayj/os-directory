...
title: Pick
description: Draft inventory record for Pick.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Pick", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Pick", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Pick_operating_system, title: "Pick", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Pick_operating_system
  ...
  fields:
    ...
    first_release: 1965 ( GIRLS ), 1973 (Reality Operating System)
    latest_release: null
    last_updated: null
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Pick_operating_system).
