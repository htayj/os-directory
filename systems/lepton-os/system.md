...
title: "Lepton"
description: Draft multilingual inventory record for Lepton.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "Lepton", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Lepton", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
POSIX real-time embedded operating-system identity from the French listing; core attributes remain unresearched.
