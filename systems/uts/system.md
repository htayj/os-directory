...
title: Amdahl UTS
description: Draft inventory record for Amdahl UTS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Amdahl UTS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Amdahl UTS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Amdahl_UTS).
