...
title: OS4000
description: Draft inventory record for OS4000.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "OS4000", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "OS4000", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/OS4000).
