...
title: CP-40
description: Draft inventory record for CP-40.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "CP-40", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "CP-40", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/CP-40, title: "CP-40", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/CP-40
  ...
  fields:
    ...
    first_release: January 1967 ; 59 years ago ( 1967-01 )
    latest_release: null
    last_updated: null
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/CP-40).
