...
description: Draft inventory record for Incompatible Timesharing System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Incompatible Timesharing System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Incompatible Timesharing System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Incompatible_Timesharing_System, title: "Incompatible Timesharing System", source_kind: article }]
...
first_pass_attributes:
  ...
  fields:
    ...
    first_release: July 1967 ; 59 years ago ( 1967-07 )
    latest_release: null
    last_updated: null
    development_status: Active
    source_model: null
    os_family: null
    gui: Command-line interface ( DDT )
    platforms: Digital PDP-6 , PDP-10 , ( emulators now available)
    kernel_type: null
    license: GPL-3.0-or-later (current versions) GPL-2.0-or-later (1999 source release)
  country_evidence:
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Incompatible_Timesharing_System).
