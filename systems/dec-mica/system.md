...
names: [{ value: "DEC MICA", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/DEC_MICA
  ...
  fields:
    ...
    purpose: Minicomputers , Workstations
    programming_languages: PILLAR, C , SPASM
    first_release: null
    latest_release: null
    last_updated: null
