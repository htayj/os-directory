...
title: OS-9
description: Draft inventory record for OS-9.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "OS-9", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "OS-9", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/OS-9, title: "OS-9", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/OS-9
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q1871106
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/OS-9).
