...
title: Real-Time Multiprogramming Operating System
description: Draft inventory record for Real-Time Multiprogramming Operating System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Real-Time Multiprogramming Operating System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Real-Time Multiprogramming Operating System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Real-Time_Multiprogramming_Operating_System, title: "Real-Time Multiprogramming Operating System", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Real-Time_Multiprogramming_Operating_System
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q54173
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Real-Time_Multiprogramming_Operating_System).
