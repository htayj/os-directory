...
title: Xerox Operating System
description: Draft inventory record for Xerox Operating System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Xerox Operating System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Xerox Operating System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Xerox_Operating_System, title: "Xerox Operating System", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Xerox_Operating_System
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Xerox_Operating_System).
