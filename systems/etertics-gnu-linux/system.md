...
description: Draft multilingual inventory record for EterTICs GNU/Linux.
...
discovery_provenance:
  - { method: multilingual-manifest, language: es, native_label: "EterTICs GNU/Linux", source: inventory/multilingual/manifests/batch-003.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "EterTICs GNU/Linux", kind: official, language: es, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
...
Argentine radio-oriented GNU/Linux distribution; country evidence is direct from the multilingual manifest.
