...
title: Atari TOS
description: Atari operating-system lineage for ST-series computers.
tags: [operating-system, atari, tos]
status: draft
schema_version: "0.1"
as_of: 2026-07-26
...
source_list: { title: List of operating systems, revision: 1365063001, occurrences: [{ section: [Proprietary, Atari], label: Atari TOS, position: 57, target: https://en.wikipedia.org/wiki/Atari_TOS, depth: 1 }] }
discovery_provenance: [{ method: english-list, language: en, native_label: Atari TOS, source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: Atari TOS, kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
kernels: []
interfaces: []
hardware_platforms: [{ platform: Atari ST series, support_origin: original-target, support_status: historical, execution_mode: native, evidence: [wikipedia], assertion_status: provisional }]
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Atari_TOS, title: Atari TOS, source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Atari_TOS
  ...
  fields:
    ...
    first_release: 20 November 1985 ; 40 years ago ( 1985-11-20 )
    latest_release: '4.04'
    last_updated: '4.04'
...
Atari TOS is retained as a distinct named Atari operating-system lineage.[^wikipedia]

[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Atari_TOS).
