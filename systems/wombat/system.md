...
names: [{ value: "Wombat", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Wombat_(operating_system)
  ...
  fields:
    ...
    first_release: 2004 ; 22 years ago ( 2004 )
    latest_release: 2.6.9.1
    last_updated: 2.6.9.1
    development_status: null
    source_model: null
    os_family: L4
    gui: null
    platforms: x86 , ARM , MIPS
    kernel_type: Microkernel paravirtualised Linux (running on L4Ka::Pistachio and
      IGUANA )
    license: GPLv2
