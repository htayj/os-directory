...
description: Draft inventory record for PlayStation 5 system software.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "PlayStation 5 system software", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "PlayStation 5 system software", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/PlayStation_5_system_software, title: "PlayStation 5 system software", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/PlayStation_5_system_software
  ...
  fields:
    ...
    purpose: Home video game console
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/PlayStation_5_system_software).
