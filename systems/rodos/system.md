...
title: "Rodos"
description: Draft multilingual inventory record for Rodos.
...
discovery_provenance:
  - { method: multilingual-manifest, language: de, native_label: "Rodos", source: inventory/multilingual/manifests/batch-003.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Rodos", kind: official, language: de, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
German-source embedded real-time operating-system identity; technical attributes remain unresearched.
