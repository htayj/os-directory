...
title: "هليوان لينكس (Helwan Linux)"
description: Draft multilingual inventory record for هليوان لينكس (Helwan Linux).
...
discovery_provenance:
  - { method: multilingual-manifest, language: ar, native_label: "هليوان لينكس (Helwan Linux)", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "هليوان لينكس (Helwan Linux)", kind: official, language: ar, script: Arab, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: [EG]
...
# هليوان لينكس (Helwan Linux)

Egypt-based Arch distribution; first-pass country evidence is direct from the project source.
