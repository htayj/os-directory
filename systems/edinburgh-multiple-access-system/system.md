...
title: Edinburgh Multiple Access System
description: Draft inventory record for Edinburgh Multiple Access System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Edinburgh Multiple Access System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Edinburgh Multiple Access System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Edinburgh_Multiple_Access_System).
