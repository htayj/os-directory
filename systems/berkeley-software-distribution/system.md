...
description: Draft inventory record for Berkeley Software Distribution.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Berkeley Software Distribution", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Berkeley Software Distribution", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Berkeley_Software_Distribution).
