...
names: [{ value: "OS/390", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/OS/390
  ...
  fields:
    ...
    first_release: 1995 ; 31 years ago ( 1995 )
    latest_release: null
    last_updated: null
