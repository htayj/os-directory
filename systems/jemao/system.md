...
title: "JemaOS"
description: Draft multilingual inventory record for JemaOS.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "JemaOS", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "JemaOS", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
...
French operating-system identity intended for older computers; country evidence is direct from the multilingual manifest.
