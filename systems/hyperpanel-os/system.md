...
title: "Hyperpanel OS"
description: Draft multilingual inventory record for Hyperpanel OS.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "Hyperpanel OS", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Hyperpanel OS", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
RTOS/GPOS system identity from the French listing; core attributes remain unresearched.
