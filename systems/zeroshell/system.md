...
title: Zeroshell
description: Draft inventory record for Zeroshell.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Zeroshell", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Zeroshell", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Zeroshell, title: "Zeroshell", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Zeroshell
  ...
  fields:
    ...
    first_release: June 2006 ; 20 years ago ( 2006-06 )
    latest_release: null
    last_updated: null
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Zeroshell).
