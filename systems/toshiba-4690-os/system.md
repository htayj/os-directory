...
title: Toshiba 4690 OS
description: Toshiba point-of-sale operating system based on IBM 4690 OS and FlexOS.
tags: [operating-system, toshiba, pos, flexos]
status: draft
schema_version: "0.1"
as_of: 2026-07-26
...
source_list: { title: List of operating systems, revision: 1365063001, occurrences: [{ section: [Proprietary, "Digital Research, Inc."], label: "Toshiba 4690 OS , a POS operating system based on IBM 4690 OS and FlexOS", position: 146, target: https://en.wikipedia.org/wiki/Toshiba_4690_OS, depth: 5, parent_position: 145 }, { section: [Proprietary, IBM, "On PC and Intel x86 based architectures"], label: "Toshiba 4690 OS version 6.4", position: 308, target: https://en.wikipedia.org/wiki/Toshiba_4690_OS, depth: 3, parent_position: 307 }] }
discovery_provenance: [{ method: english-list, language: en, native_label: Toshiba 4690 OS, source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: Toshiba 4690 OS, kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: [{ organization: Toshiba, roles: [developer, vendor], evidence: [wikipedia], assertion_status: provisional }]
countries_of_origin: []
design_purposes: []
...
Toshiba 4690 OS is retained as a named POS system derived from IBM 4690 OS and
FlexOS.[^wikipedia]

[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Toshiba_4690_OS).
