...
names: [{ value: "OPENSTEP", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/OPENSTEP
  ...
  fields:
    ...
    programming_languages: Objective-C
    first_release: null
    latest_release: null
    last_updated: null
