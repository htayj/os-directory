...
names: [{ value: "TSX-32", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/TSX-32
  ...
  fields:
    ...
    latest_release: 6.34 / 2002?
    last_updated: 6.34 / 2002?
