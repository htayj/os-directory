...
title: APEX
description: A time- and memory-sharing executive for quick-response online applications on the MIT Lincoln Laboratory TX-2.
tags:
- operating-system
- gunkies-discovery
- historical
...
- method: gunkies-category-audit
  language: en
  source: https://gunkies.org/wiki/APEX
  source_revision: 36818
...
development_status:
  ...
  assertion_status: provisional
design_purposes:
- value: interactive-timesharing
  evidence:
  - gunkies-apex-tx-2
  assertion_status: provisional
  primary: true
- value: online-applications
  evidence:
  - gunkies-apex-tx-2
  assertion_status: provisional
  primary: false
...
- value: TX-2
  ...
  assertion_status: provisional
sources:
- id: gunkies-apex-tx-2
  resource: https://gunkies.org/w/index.php?title=APEX&oldid=36818
  title: APEX
  source_kind: historical-computing-wiki
  revision: 36818
  revision_timestamp: '2025-10-07T11:09:15Z'
organizations:
