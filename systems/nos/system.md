...
title: NOS
description: Control Data Corporation Network Operating System lineage.
...
source_list: { title: List of operating systems, revision: 1365063001, occurrences: [{ section: [Proprietary, Control Data Corporation, "6x00 and related Cyber"], label: "NOS (Network Operating System)", position: 98, target: https://en.wikipedia.org/wiki/NOS_(operating_system), depth: 4, parent_position: 97 }] }
discovery_provenance: [{ method: english-list, language: en, native_label: NOS, source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: NOS, kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }, { value: Network Operating System, kind: expanded, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
...
NOS is retained as the named Control Data Network Operating System lineage.[^wikipedia]

[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/NOS_(operating_system)).
