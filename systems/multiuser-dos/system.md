...
title: Multiuser DOS
description: Digital Research multiuser and multitasking DOS operating-system lineage.
tags: [operating-system, dos, multitasking]
status: draft
...
design_purposes: [{ value: time-sharing, primary: true, evidence: [discovery], assertion_status: provisional }]
...
Named Digital Research lineage; detailed primary-source review is pending.
