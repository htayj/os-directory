...
title: "起点操作系统"
description: Draft multilingual inventory record for 起点操作系统.
...
discovery_provenance:
  - { method: multilingual-manifest, language: zh, native_label: "起点操作系统", source: inventory/multilingual/manifests/batch-012.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "起点操作系统", kind: official, language: zh, script: Hani, evidence: [multilingual-manifest], assertion_status: provisional }
...
Separately named Chinese Linux distribution/lineage; predecessor naming remains for later lifecycle research.
