...
discovery_provenance:
  - { method: multilingual-manifest, language: "fr", native_label: "Unununium", source: inventory/multilingual/manifests/batch-006.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Unununium", kind: official, language: "fr", script: Latn, evidence: [discovery], assertion_status: provisional }
organizations: []
countries_of_origin: []
design_purposes: []
...
Discovery rationale: Listed as an experimental operating system and absent from the English frozen corpus.
