...
title: "عرببكس (Arabbix)"
description: Draft multilingual inventory record for عرببكس (Arabbix).
...
discovery_provenance:
  - { method: multilingual-manifest, language: ar, native_label: "عرببكس (Arabbix)", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "عرببكس (Arabbix)", kind: official, language: ar, script: Arab, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
Arabic-localized live-CD distribution; detailed technical attributes remain unresearched.
