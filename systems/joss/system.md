...
title: JOSS
description: RAND's interactive time-sharing system and programming environment, first for JOHNNIAC and later the PDP-6.
tags:
- operating-system
- gunkies-discovery
- historical
...
- method: gunkies-category-audit
  language: en
  source: https://gunkies.org/wiki/JOSS
  source_revision: 30142
...
- value: JOHNNIAC Open Shop System
  kind: alias
  language: en
  script: Latn
  evidence:
...
- value: DEC PDP-6
  ...
  - gunkies-joss
  assertion_status: provisional
- value: IBM System/370
  evidence:
  - gunkies-joss
  assertion_status: provisional
sources:
- id: gunkies-joss
  resource: https://gunkies.org/w/index.php?title=JOSS&oldid=30142
  title: JOSS
  source_kind: historical-computing-wiki
  revision: 30142
  revision_timestamp: '2023-06-20T05:45:36Z'
organizations:
