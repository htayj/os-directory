...
title: XTS-400
description: Trusted operating system developed for BAE Systems.
tags: [operating-system, bae-systems, trusted-computing]
status: draft
schema_version: "0.1"
as_of: 2026-07-26
...
source_list: { title: List of operating systems, revision: 1365063001, occurrences: [{ section: [Proprietary, BAE Systems], label: XTS-400, position: 60, target: https://en.wikipedia.org/wiki/XTS-400, depth: 1 }] }
discovery_provenance: [{ method: english-list, language: en, native_label: XTS-400, source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: XTS-400, kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/XTS-400, title: XTS-400, source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/XTS-400
  retrieved_at: '2026-07-26'
  assertion_status: provisional
  note: Raw discovery metadata from the linked English Wikipedia infobox; normalize
    and verify against stronger sources before marking verified.
  fields:
    developer: BAE Systems Inc.
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q739416
...
XTS-400 is retained as the named trusted operating-system identity in the
source list.[^wikipedia]

[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/XTS-400).
