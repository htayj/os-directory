...
description: Draft inventory record for Honeywell CP-6.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Honeywell CP-6", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Honeywell CP-6", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Honeywell_CP-6).
