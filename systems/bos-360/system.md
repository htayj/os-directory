...
names: [{ value: "BOS/360", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/BOS/360
  ...
  fields:
    ...
    first_release: October 1965 ; 60 years ago ( 1965-10 )
    latest_release: null
    last_updated: null
