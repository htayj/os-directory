...
title: "深度操作系统"
description: Draft multilingual inventory record for 深度操作系统.
...
discovery_provenance:
  - { method: multilingual-manifest, language: zh, native_label: "深度操作系统", source: inventory/multilingual/manifests/batch-011.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "深度操作系统", kind: official, language: zh, script: Hani, evidence: [multilingual-manifest], assertion_status: provisional }
...
multilingual_wikidata_snapshot:
  candidate_id: deepin
  wikidata_entity: Q129145
  source: https://www.wikidata.org/wiki/Q129145
...
multilingual_infobox_snapshot:
  source: https://en.wikipedia.org/wiki/Deepin
  retrieved_at: '2026-07-26'
  assertion_status: provisional
  ...
  fields:
    ...
    programming_languages: null
    first_release: 28 February 2004 ; 22 years ago ( 2004-02-28 )
    latest_release: 25.0.1 / 19 January 2026
    last_updated: 25.0.1 / 19 January 2026
    development_status: Current
    source_model: Open-source
    os_family: Linux ( Unix-like )
    gui: Deepin Desktop Environment ( Qt -based)
    platforms: x86-64 , RISCV64 , ARM64 , LoongArch64
...
Chinese desktop Linux distribution identity; country evidence is direct from the multilingual manifest.
