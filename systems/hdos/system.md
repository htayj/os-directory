...
title: HDOS
description: Draft inventory record for HDOS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "HDOS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "HDOS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/HDOS, title: "HDOS", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/HDOS
  ...
  fields:
    ...
    os_family: null
    gui: null
    platforms: Heathkit H8 , Heathkit H89 , Zenith Z-89
    kernel_type: null
    license: Public domain
  country_evidence:
    assertion_status: inferred
    method: inferred-from-developer-country
    source: https://www.wikidata.org/wiki/Q119440701
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/HDOS).
