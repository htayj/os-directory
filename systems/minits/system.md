...
title: MINITS
description: An MIT PDP-11 multitasking operating system used primarily for network routers, terminal concentrators, graphics terminals, and Chaosnet front ends.
tags:
- operating-system
- gunkies-discovery
- historical
...
- method: gunkies-category-audit
  language: en
  source: https://gunkies.org/wiki/MINITS
  source_revision: 36103
...
sources:
- id: gunkies-minits
  resource: https://gunkies.org/w/index.php?title=MINITS&oldid=36103
  title: MINITS
  source_kind: historical-computing-wiki
  revision: 36103
  revision_timestamp: '2025-04-14T17:48:11Z'
organizations:
