...
description: Draft inventory record for Nintendo DSi system software.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Nintendo DSi system software", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Nintendo DSi system software", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Nintendo_DSi_system_software).
