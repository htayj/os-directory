...
title: "Dragora GNU/Linux-Libre"
description: Draft multilingual inventory record for Dragora GNU/Linux-Libre.
...
discovery_provenance:
  - { method: multilingual-manifest, language: es, native_label: "Dragora GNU/Linux-Libre", source: inventory/multilingual/manifests/batch-003.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Dragora GNU/Linux-Libre", kind: official, language: es, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: [AR]
...
sources:
  ...
  - { id: es-os-list, resource: "https://es.wikipedia.org/wiki/Anexo:Sistemas_operativos", title: "Anexo:Sistemas operativos", source_kind: language-list }
  - { id: huayra, resource: "https://huayra.educar.gob.ar/", title: "Huayra GNU/Linux", source_kind: government-education-project-site }
...
Argentine freedom-focused GNU/Linux distribution; country evidence is direct from the multilingual manifest.
