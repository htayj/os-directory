...
names: [{ value: "Linux", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  ...
  fields:
    ...
    purpose: General-purpose [ a ]
    programming_languages: null
    first_release: 17 September 1991 ; 34 years ago ( 1991-09-17 ) (kernel)
    latest_release: null
    last_updated: null
    development_status: Current
    source_model: Open source ( kernel )
    os_family: Unix-like
    gui: null
    platforms: Various [ b ]
    kernel_type: Monolithic
    license: GPLv2 ( kernel ) [ g ]
