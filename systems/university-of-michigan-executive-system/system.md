...
description: Draft inventory record for University of Michigan Executive System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "University of Michigan Executive System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "University of Michigan Executive System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/University_of_Michigan_Executive_System).
