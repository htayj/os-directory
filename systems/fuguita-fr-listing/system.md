...
title: "FuguIta"
description: Draft multilingual inventory record for FuguIta.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "FuguIta", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "FuguIta", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
multilingual_wikidata_snapshot:
  candidate_id: fuguita-fr-listing
...
OpenBSD-derivative system identity found in the French listing; core attributes remain unresearched.
