...
title: Control Program Facility
description: Draft inventory record for Control Program Facility.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Control Program Facility", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Control Program Facility", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Control_Program_Facility).
