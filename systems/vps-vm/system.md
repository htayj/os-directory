...
names: [{ value: "VPS/VM", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/VPS/VM
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q49110
