...
title: "麒麟操作系统"
description: Draft multilingual inventory record for 麒麟操作系统.
...
discovery_provenance:
  - { method: multilingual-manifest, language: zh, native_label: "麒麟操作系统", source: inventory/multilingual/manifests/batch-011.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "麒麟操作系统", kind: official, language: zh, script: Hani, evidence: [multilingual-manifest], assertion_status: provisional }
...
Chinese operating-system lineage identity; country evidence is direct from the multilingual manifest.
