...
title: "حيدر لينكس (Haydar Linux)"
description: Draft multilingual inventory record for حيدر لينكس (Haydar Linux).
...
discovery_provenance:
  - { method: multilingual-manifest, language: ar, native_label: "حيدر لينكس (Haydar Linux)", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "حيدر لينكس (Haydar Linux)", kind: official, language: ar, script: Arab, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
Historical Arabic Linux distribution; detailed technical attributes remain unresearched.
