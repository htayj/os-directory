...
title: Trusted Solaris
description: Draft inventory record for Trusted Solaris.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Trusted Solaris", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Trusted Solaris", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Trusted_Solaris, title: "Trusted Solaris", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Trusted_Solaris
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Trusted_Solaris).
