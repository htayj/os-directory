...
title: RT-11
description: Draft inventory record for RT-11.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "RT-11", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "RT-11", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/RT-11, title: "RT-11", source_kind: article }]
---
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/RT-11).
