...
discovery_provenance:
  - { method: multilingual-manifest, language: "fr", native_label: "Tunes OS", source: inventory/multilingual/manifests/batch-006.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Tunes OS", kind: official, language: "fr", script: Latn, evidence: [discovery], assertion_status: provisional }
organizations: []
countries_of_origin: []
design_purposes: []
