...
discovery_provenance:
  - { method: multilingual-manifest, language: "es", native_label: "Tuquito", source: inventory/multilingual/manifests/batch-004.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "Tuquito", kind: official, language: "es", script: Latn, evidence: [discovery], assertion_status: provisional }
organizations: []
countries_of_origin: []
design_purposes: []
...
Discovery rationale: Defunct Argentine GNU/Linux distribution from Tucumán, based on Debian and Ubuntu. The identity is cataloged as a distribution, not as a replacement kernel or merely a LiveCD release.
