...
names: [{ value: "Dynix", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Dynix
  ...
  fields:
    ...
    source_model: null
    os_family: Unix-like ( BSD or SysV )
    gui: null
    platforms: x86
    kernel_type: null
    license: null
