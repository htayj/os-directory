...
title: "中国操作系统"
description: Draft multilingual inventory record for 中国操作系统.
...
discovery_provenance:
  - { method: multilingual-manifest, language: zh, native_label: "中国操作系统", source: inventory/multilingual/manifests/batch-011.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "中国操作系统", kind: official, language: zh, script: Hani, evidence: [multilingual-manifest], assertion_status: provisional }
...
multilingual_wikidata_snapshot:
  candidate_id: china-operating-system-cos
...
Chinese mobile/tablet/set-top-box operating-system identity; country evidence is direct from the multilingual manifest.
