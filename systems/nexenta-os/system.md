...
title: Nexenta OS
description: Draft inventory record for Nexenta OS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Nexenta OS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Nexenta OS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Nexenta_OS, title: "Nexenta OS", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Nexenta_OS
  ...
  fields:
    ...
    os_family: Unix-like ( SVR4 and Linux )
    gui: Command line / GNOME
    platforms: i386 , AMD64 , SPARC
    kernel_type: Monolithic (illumos)
    license: Various
  country_evidence:
    assertion_status: inferred
    method: inferred-from-developer-country
    source: https://www.wikidata.org/wiki/Q16928036
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Nexenta_OS).
