...
discovery_provenance:
  - { method: multilingual-manifest, language: "fr", native_label: "AcidOS", source: inventory/multilingual/manifests/batch-004.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "AcidOS", kind: official, language: "fr", script: Latn, evidence: [discovery], assertion_status: provisional }
organizations: []
countries_of_origin: []
design_purposes: []
...
Discovery rationale: French list describes an industrial/IoT-oriented French OS; needs later primary-source validation.
