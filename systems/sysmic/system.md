...
title: "SYSMIC"
description: Draft multilingual inventory record for SYSMIC.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "SYSMIC", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "SYSMIC", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
...
French R2E operating-system identity preceding Prologue; country evidence is direct from the multilingual manifest.
