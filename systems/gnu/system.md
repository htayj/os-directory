...
names: [{ value: "GNU", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  ...
  fields:
    ...
    purpose: Personal computers, mobile devices, embedded devices, servers, mainframes,
      supercomputers
    programming_languages: Various languages (notably C and assembly language )
    first_release: null
    latest_release: null
    last_updated: null
    ...
    os_family: Unix-like
    gui: null
    platforms: Alpha , ARC , ARM , AVR32 , Blackfin , C6x , ETRAX CRIS , FR-V , H8/300
      , IA-32 / x86-64 , Hexagon , Itanium , M32R , m68k , META , MicroBlaze , MIPS
      , MN103 , OpenRISC , PA-RISC , PowerPC , s390 / s390x , S+core , SuperH , SPARC
      , TILE64 , Unicore32 , Xtensa , RISC-V (with Linux-libre kernel only)
    kernel_type: Microkernel ( GNU Hurd ) or Monolithic kernel (GNU Linux-libre ,
      fork of Linux )
