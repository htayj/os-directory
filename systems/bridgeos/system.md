...
title: bridgeOS
description: Apple embedded operating system identity with limited first-pass public evidence.
tags: [operating-system, apple, embedded]
status: draft
...
field_dispositions:
  ...
  - { field: gui_status, disposition: unknown, checked_at: 2026-07-26 }
...
source_list: { title: "List of operating systems", revision: 1365063001, occurrences: [{ section: [Proprietary, Apple], label: bridgeOS, position: 48, target: "https://en.wikipedia.org/wiki/BridgeOS", depth: 4, parent_position: 47 }] }
discovery_provenance: [{ method: english-list, language: en, source: wikipedia-list, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: bridgeOS, kind: official, language: en, script: Latn, evidence: [bridgeos-discovery], assertion_status: provisional }]
sources:
  ...
  - { id: bridgeos-discovery, resource: "https://en.wikipedia.org/wiki/BridgeOS", title: "BridgeOS", source_kind: article }
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/BridgeOS
  ...
  fields:
    ...
    first_release: October 27, 2016 ; 9 years ago ( 2016-10-27 )
    latest_release: null
    last_updated: null
    development_status: Current
    source_model: Closed , with open-source components
    os_family: Unix-like , iOS
    gui: null
    platforms: T series (2016 MacBook Pro and later)
    kernel_type: null
...
bridgeOS is retained as a separately named embedded OS identity; public primary evidence needs follow-up.
