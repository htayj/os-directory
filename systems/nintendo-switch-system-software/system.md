...
names: [{ value: "Nintendo Switch system software", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Nintendo_Switch_system_software
  ...
  fields:
    ...
    purpose: null
    programming_languages: C , C++ and HTML for eShop and online services settings
    first_release: 1.0.0 (March 3, 2017 ; 9 years ago ( 2017-03-03 ) )
    latest_release: 22.5.0 (June 15, 2026 ; 35 days ago ( 2026-06-15 ) ) [ ± ] 19.0.2
      (January 20, 2026 ; 6 months ago ( 2026-01-20 ) ) (Tencent Nintendo Switch only)
    last_updated: 22.5.0 (June 15, 2026 ; 35 days ago ( 2026-06-15 ) ) [ ± ] 19.0.2
      (January 20, 2026 ; 6 months ago ( 2026-01-20 ) ) (Tencent Nintendo Switch only)
    development_status: Current
    source_model: Closed source
    os_family: Proprietary, derivative of the Nintendo 3DS system software (containing
      components which are based on FreeBSD and Android )
    gui: null
    platforms: Nintendo Switch Nintendo Switch Lite Nintendo Switch OLED Nintendo
      Switch 2
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q1068734
