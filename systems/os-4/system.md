...
title: OS/4
description: Draft inventory record for OS/4.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "OS/4", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "OS/4", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/OS/4, title: "OS/4", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/OS/4
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/OS/4).
