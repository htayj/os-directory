...
title: UNIVAC EXEC I
description: Draft inventory record for UNIVAC EXEC I.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "UNIVAC EXEC I", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "UNIVAC EXEC I", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/UNIVAC_EXEC_I, title: "UNIVAC EXEC I", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/UNIVAC_EXEC_I
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/UNIVAC_EXEC_I).
