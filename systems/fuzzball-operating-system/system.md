...
title: Fuzzball
description: David Mills's PDP-11 experimental networking operating system, widely used as an NSFNET backbone router and time server.
tags:
- operating-system
- gunkies-discovery
- historical
...
- method: gunkies-category-audit
  language: en
  source: https://gunkies.org/wiki/Fuzzball
  source_revision: 36303
...
- value: Fuzzball
  ...
  script: Latn
  evidence:
  - gunkies-fuzzball-operating-system
...
- value: DEC PDP-11
  ...
  assertion_status: provisional
sources:
- id: gunkies-fuzzball-operating-system
  resource: https://gunkies.org/w/index.php?title=Fuzzball&oldid=36303
  title: Fuzzball
  source_kind: historical-computing-wiki
  revision: 36303
  revision_timestamp: '2025-05-29T01:47:16Z'
organizations:
