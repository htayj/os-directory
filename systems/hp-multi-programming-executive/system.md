...
title: HP Multi-Programming Executive
description: Draft inventory record for HP Multi-Programming Executive.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "HP Multi-Programming Executive", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "HP Multi-Programming Executive", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/HP_Multi-Programming_Executive).
