...
names: [{ value: "IPFire", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/IPFire
  ...
  fields:
    ...
    first_release: null
    latest_release: Version 2.29 Core Update 199 / January 7, 2026 ; 6 months ago
      ( 2026-01-07 )
    last_updated: Version 2.29 Core Update 199 / January 7, 2026 ; 6 months ago (
      2026-01-07 )
    development_status: null
    source_model: Open source ( free software )
    os_family: null
    gui: null
    platforms: x86-64 , AArch64 , RISC-V (experimental)
