...
title: "SCP (Single User Control Program)"
description: Draft multilingual inventory record for SCP (Single User Control Program).
...
discovery_provenance:
  - { method: multilingual-manifest, language: de, native_label: "SCP (Single User Control Program)", source: inventory/multilingual/manifests/batch-003.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "SCP (Single User Control Program)", kind: official, language: de, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
sources:
  - { id: multilingual-manifest, resource: "inventory/multilingual/manifests/batch-003.json", title: "Multilingual catalog batch 003", source_kind: inventory-manifest }
  - { id: de-os-list, resource: "https://de.wikipedia.org/wiki/Liste_von_Betriebssystemen", title: "Liste von Betriebssystemen", source_kind: language-list }
  - { id: scp, resource: "https://de.wikipedia.org/wiki/Single_User_Control_Program", title: "Single User Control Program", source_kind: article }
  - { id: microos, resource: "https://de.wikipedia.org/wiki/MicroOS", title: "MicroOS", source_kind: article }
  - { id: tcos, resource: "https://de.wikipedia.org/wiki/TCOS", title: "TCOS", source_kind: article }
...
multilingual_wikidata_snapshot:
  candidate_id: single-user-control-program-scp
...
DDR CP/M-compatible operating-system identity; country normalization and technical attributes remain unresearched.
