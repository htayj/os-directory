...
title: "أعجوبة لينكس (Ojuba Linux)"
description: Draft multilingual inventory record for أعجوبة لينكس (Ojuba Linux).
...
discovery_provenance:
  - { method: multilingual-manifest, language: ar, native_label: "أعجوبة لينكس (Ojuba Linux)", source: inventory/multilingual/manifests/batch-001.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "أعجوبة لينكس (Ojuba Linux)", kind: official, language: ar, script: Arab, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: []
...
# أعجوبة لينكس (Ojuba Linux)

Arabic Fedora-compatible distribution; detailed technical attributes remain unresearched.
