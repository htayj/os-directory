...
names: [{ value: "Kali NetHunter", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Kali_NetHunter
  ...
  fields:
    ...
    purpose: null
    programming_languages: C, Java, Kotlin, Python, Bash
    first_release: null
    latest_release: null
    last_updated: null
