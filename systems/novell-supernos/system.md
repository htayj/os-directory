...
names: [{ value: "Novell SuperNOS", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Novell_%22SuperNOS%22
  retrieved_at: '2026-07-26'
  assertion_status: provisional
  note: Raw discovery metadata from the linked English Wikipedia infobox; normalize
    and verify against stronger sources before marking verified.
  fields:
    developer: Xinuos (previously Univel , Novell , SCO , Caldera Systems , Caldera
      International , The SCO Group )
    country_of_origin: null
    purpose: null
    programming_languages: null
    first_release: 1992 ; 34 years ago ( 1992 )
    latest_release: 7 Definitive 2018 (D2M1b) / 2022 ; 4 years ago ( 2022 )
    last_updated: 7 Definitive 2018 (D2M1b) / 2022 ; 4 years ago ( 2022 )
    development_status: Current
    source_model: Closed source
    os_family: Unix ( SVR4.2 / SVR5 )
    gui: null
    platforms: null
