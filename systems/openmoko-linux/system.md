...
title: Openmoko Linux
description: Draft inventory record for Openmoko Linux.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "Openmoko Linux", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "Openmoko Linux", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/Openmoko_Linux, title: "Openmoko Linux", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/Openmoko_Linux
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q645950
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/Openmoko_Linux).
