...
title: "CLIP OS"
description: Draft multilingual inventory record for CLIP OS.
...
discovery_provenance:
  - { method: multilingual-manifest, language: fr, native_label: "CLIP OS", source: inventory/multilingual/manifests/batch-005.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "CLIP OS", kind: official, language: fr, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
countries_of_origin: [FR]
...
sources:
  - { id: multilingual-manifest, resource: "inventory/multilingual/manifests/batch-005.json", title: "Multilingual catalog batch 005", source_kind: inventory-manifest }
  - { id: fr-os-list, resource: "https://fr.wikipedia.org/wiki/Liste_des_syst%C3%A8mes_d%27exploitation", title: "Liste des systèmes d'exploitation", source_kind: language-list }
  - { id: fr-kernel-list, resource: "https://fr.wikipedia.org/wiki/Liste_des_noyaux_de_syst%C3%A8mes_d%27exploitation", title: "Liste des noyaux de systèmes d'exploitation", source_kind: language-list }
  - { id: fr-os-chronology, resource: "https://fr.wikipedia.org/wiki/Chronologie_des_syst%C3%A8mes_d%27exploitation", title: "Chronologie des systèmes d'exploitation", source_kind: language-list }
# BEGIN GENERATED MULTILINGUAL WIKIDATA
multilingual_wikidata_snapshot:
  candidate_id: clip-os
...
ANSSI-developed French operating-system identity; country evidence is direct from the multilingual manifest.
