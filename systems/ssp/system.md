...
title: System Support Program
description: Draft inventory record for System Support Program.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "System Support Program", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "System Support Program", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/System_Support_Program).
