...
title: PenPoint OS
description: Draft inventory record for PenPoint OS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "PenPoint OS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "PenPoint OS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/PenPoint_OS).
