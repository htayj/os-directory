...
title: "SOX (Sistema Operacional X)"
description: Draft multilingual inventory record for SOX (Sistema Operacional X).
...
discovery_provenance:
  - { method: multilingual-manifest, language: pt, native_label: "SOX (Sistema Operacional X)", source: inventory/multilingual/manifests/batch-011.json, observed_at: 2026-07-26, disposition: included-system }
names:
  - { value: "SOX (Sistema Operacional X)", kind: official, language: pt, script: Latn, evidence: [multilingual-manifest], assertion_status: provisional }
...
multilingual_wikidata_snapshot:
  candidate_id: sox-sistema-operacional-x
  wikidata_entity: Q7392165
  source: https://www.wikidata.org/wiki/Q7392165
...
multilingual_infobox_snapshot:
  source: https://en.wikipedia.org/wiki/SOX_(operating_system)
  retrieved_at: '2026-07-26'
  assertion_status: provisional
...
Brazilian UNIX-compatible operating-system identity; country evidence is direct from the multilingual manifest.
