...
title: OSv
description: Draft inventory record for OSv.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "OSv", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "OSv", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/OSv, title: "OSv", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/OSv
  ...
  fields:
    ...
    first_release: September 16, 2013 ; 12 years ago ( 2013-09-16 )
    latest_release: null
    last_updated: null
    ...
    os_family: null
    gui: CLI, web
    platforms: x86-64 using the KVM , Xen , VMware , and VirtualBox hypervisors. (arm64
      on KVM is under development)
    kernel_type: Unikernel
    license: BSD license
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/OSv).
