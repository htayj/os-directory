...
names: [{ value: "MS-Net", kind: official, language: en, script: Latn, evidence: [wikipedia-list], assertion_status: provisional }]
...
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/MS-Net
  ...
  fields:
    ...
    programming_languages: x86 assembly
    first_release: April 2, 1985 ; 41 years ago ( 1985-04-02 )
    latest_release: null
    last_updated: null
