...
title: SHARE Operating System
description: Draft inventory record for SHARE Operating System.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "SHARE Operating System", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "SHARE Operating System", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/SHARE_Operating_System, title: "SHARE Operating System", source_kind: article }]
# BEGIN GENERATED ENWIKI INFOBOX
first_pass_attributes:
  source: https://en.wikipedia.org/wiki/SHARE_Operating_System
  ...
  fields:
    ...
    first_release: 1959 ; 67 years ago ( 1959 )
    latest_release: null
    last_updated: null
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q7390169
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/SHARE_Operating_System).
