...
title: ExtremeXOS
description: Draft inventory record for ExtremeXOS.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "ExtremeXOS", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "ExtremeXOS", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
hardware_platforms: []
architectures: []
sources: [{ id: wikipedia, resource: https://en.wikipedia.org/wiki/ExtremeXOS, title: "ExtremeXOS", source_kind: article }]
...
first_pass_attributes:
  ...
  fields:
    ...
    first_release: 'version 10.1: February, 2004'
    latest_release: v33.3.1.4 / 16.04.2025
    last_updated: v33.3.1.4 / 16.04.2025
    development_status: Current
    source_model: Closed source and partly Open source
    os_family: Unix-like
  ...
  country_evidence:
    ...
    source: https://www.wikidata.org/wiki/Q2034659
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/ExtremeXOS).
