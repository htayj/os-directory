...
title: TOPS-10
description: Draft inventory record for TOPS-10.
...
discovery_provenance: [{ method: english-list, language: en, native_label: "TOPS-10", source: wikipedia, observed_at: 2026-07-26, disposition: included-system }]
names: [{ value: "TOPS-10", kind: official, language: en, script: Latn, evidence: [wikipedia], assertion_status: provisional }]
organizations: []
countries_of_origin: []
design_purposes: []
...
- name: AMIS
  ...
  source: https://www.wikidata.org/wiki/Q2819260
  source_kind: wikidata-P306-operating-system
  assertion_status: provisional
- name: DEC SED
  relationship: supported-platform
  interface_style: null
  source: https://www.wikidata.org/wiki/Q5204789
  source_kind: wikidata-P306-operating-system
  assertion_status: provisional
- name: SOS
  relationship: first-party
  interface_style: line
  source: https://en.wikipedia.org/wiki/SOS_(text_editor)
  source_kind: editor-history-secondary-reference
  assertion_status: provisional
- name: TECO
  relationship: first-party
  interface_style: terminal
  source: https://en.wikipedia.org/wiki/TECO_(text_editor)
  source_kind: editor-history-secondary-reference
  assertion_status: provisional
...
[^wikipedia]: [Wikipedia discovery page](https://en.wikipedia.org/wiki/TOPS-10).
