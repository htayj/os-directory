...
context.[^wikipedia-list] Enrich each concept with comparable structured fields
and claim-level provenance. Do not treat the source list as proof of every fact
about a system: it defines the coverage set.
...
## 1. Freeze and Parse the Coverage Source
...
concepts where the list names a release rather than a distinct lineage.

## 4. Enrich Core Fields
...
## 5. Add Deep Technical and Preservation Data
...
* every occurrence has a recorded disposition;
